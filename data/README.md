...
- The dataset is not included in this repository due to size; it can be downloaded from [OpenIntro Statistics](https://www.openintro.org/data/index.php?data=cdc).
